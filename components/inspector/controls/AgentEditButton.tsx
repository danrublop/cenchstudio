...
export function AgentEditButton({ label, context }: Props) {
  ...
  return (
    <span
      ...
      className="w-full flex items-center gap-1.5 px-3 py-2 bg-[var(--color-input-bg,#1a1a1f)] border border-[var(--color-border,#2a2a32)] rounded-md text-[#9a9aa8] text-[12px] font-mono cursor-pointer transition-colors hover:border-[#e84545] hover:text-[var(--color-text-primary,#f0ece0)]"
    >
